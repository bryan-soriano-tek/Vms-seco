...
#-------------------------------------------------------------------------------
PKG  = common
SRCS = switype_256bit.c dev_util.c str_util.c qmux_util.c proc_util.c
OBJS = $(OBJSDIR)/switype_256bit.o $(OBJSDIR)/dev_util.o $(OBJSDIR)/str_util.o \
	$(OBJSDIR)/qmux_util.o $(OBJSDIR)/proc_util.o
HDRS = switype_256bit.h dev_util.h str_util.h qmux_util.h proc_util.h
