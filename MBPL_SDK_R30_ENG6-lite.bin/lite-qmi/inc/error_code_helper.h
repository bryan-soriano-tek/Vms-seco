...
static const struct errorcodemap codemap[eQCWWAN_ERR_ENUM_END + 1] =
{
    ...
    {eQCWWAN_ERR_INVALID_XID,       "Invalid transaction id"},
    {eQCWWAN_ERR_MULTIPLE_SMS_UNSUPPORTED,  "Unsupported multiple SMS"},
    {eQCWWAN_ERR_TLV_LEN_MISMATCH,  "Unpack TLV error, length mismatch"},
...
{
    {eQCWWAN_ERR_QMI_MALFORMED_MSG, "Malformed or Corrupted QMI msg"},
