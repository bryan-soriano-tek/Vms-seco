 ...
 *          - see \ref eLOG_LEVEL for more information
 * 
 ...
 * 
 * @note This API is deprecated, please use SLQSGetSDKVersion(CHAR **sdkversionpp) API 
 */
char* get_version();
 ...
 *
 */
uint32_t SLQSGetSDKVersion(char **pSdkVer);
