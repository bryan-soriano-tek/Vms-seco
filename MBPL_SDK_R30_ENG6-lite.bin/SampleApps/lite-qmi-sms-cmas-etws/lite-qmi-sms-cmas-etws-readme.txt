...
lite-qmi-sms-cmas-etws (the application) is a sample application/utility that manages QMI Wireless Message Service on Sierra Wireless Modems based on Qualcomm chipsets.
...
=====================
  ...
  $cd SampleApps/lite-qmi-sms-cmas-etws/
For x86_64
  $make clean
  $make
For ARM64linaro
...
App usage: 
  ...
  -o  --operation
        ...
        Supported operations:
         ...
         RegisterSmsServiceCallbacks
          Parameters:
          -e  --enable_callback 0|1 (Mandatory)
         QuerySmsServiceCenter
         SetSmsServiceCenter
          Parameters:
          -n  --sevice_center_number Sevice Center Number string (Mandatory)
         QuerySmsList
          Parameters:
          -S  --storage_type SIM|NV (Mandatory)
          -T  --sms_tag SMS Tag 0|1|2|3 (Mandatory)
         QuerySms
          Parameters:
          -I  --sms_index SMS Index (Mandatory)
          -S  --storage_type Storage 0|1 (Mandatory)
         DeleteSms
          Parameters:
          -S  --storage_type Storage 0|1 (Optional)
          -I  --sms_index SMS index (Optional)
         SendSms
          Parameters:
          -P  --phone_number Phone Number string (Mandatory)
          -M  --message Message string (Mandatory)
         SendSmsAsync
          Parameters:
          -P  --phone_number Phone Number string (Mandatory)
          -M  --message Message string (Mandatory)
         ...
         SetSmsRoutes
          Parameters:
          -C  --class Message Class 0|1|2|3|4|5 (Mandatory)
          -S  --storage_type Storage 0|1 (Optional)
          -R  --receipt_action ReceiptAction 0|1 (Optional)

6. Examples
===========

Direct QMUX mode
  sudo ./lite-qmi-smshostx86_64 -d /dev/mhi_0200_00.01.00_pipe_12
  sudo ./lite-qmi-smshostx86_64 -d /dev/cdc-wdm0

MBIM mode
  sudo ./lite-qmi-smshostx86_64 -d /dev/mhi_0200_00.01.00_pipe_12 -m
  sudo ./lite-qmi-smshostx86_64 -d /dev/cdc-wdm0 -m

Socket mode
  sudo ./lite-qmi-smshostx86_64 -s

7. Notes, exceptions, etc.
==========================
Test Cases
  7.1 Register for SMS notifications
  7.2 Query SMS Service Center
  7.3 Set SMS Service Center
  7.4 Query SMS List
  7.5 Query SMS Item
  7.6 Delete SMS
  7.7 Send SMS
