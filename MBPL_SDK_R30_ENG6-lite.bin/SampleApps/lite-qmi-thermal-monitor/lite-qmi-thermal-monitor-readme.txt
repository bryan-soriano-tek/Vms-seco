...
lite-qmi-thermal-monitor (the application) is a sample application/utility that monitors thermal mitigation devices and thermal sensors on Sierra Wireless Modems based on Qualcomm chipsets.  
...
=====================
  ...
  $cd SampleApps/lite-qmi-thermal-monitor/
For x86_64
  $make clean
  $make
For ARM64linaro
...
App usage: 
  ...
  <appName> [[[-m|-q] [-d <QMI/MBIM device path>]]|[-r]] [-m] [-tm] [-ts] [-V] [-h]
...
Automatic mode (default)
  sudo ./lite-qmi-thermal-monitorhostx86_64 -tm -ts

Router mode (qmux-router is required to be running)
  ./lite-qmi-thermal-monitorhostx86_64 -r -tm -ts

MBIM mode
  sudo ./lite-qmi-thermal-monitorhostx86_64 -m -tm -ts

QMI mode
  sudo ./lite-qmi-thermal-monitorhostx86_64 -q -tm -ts
