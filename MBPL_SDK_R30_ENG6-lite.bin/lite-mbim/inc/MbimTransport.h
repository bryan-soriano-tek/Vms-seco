...
#define MBIM_ERROR_TIMEOUT_FRAGMENT 0x00000001
#define MBIM_ERROR_FRAGMENT_OUT_OF_SEQUENCE 0x00000002
#define MBIM_ERROR_LENGTH_MISMATCH 0x00000003
#define MBIM_ERROR_DUPLICATED_TID 0x00000004
#define MBIM_ERROR_NOT_OPENED 0x00000005
#define MBIM_ERROR_UNKNOWN 0x00000006
#define MBIM_ERROR_CANCEL 0x00000007
#define MBIM_ERROR_MAX_TRANSFER 0x00000008
 ...
 * @param[in] skipOpen      True to skip issuing a MBIM_OPEN request as part of initialization.
 *       
 ...
 * @note   skipOpen is used when we wish to inherit the current MBIM connection status from a previous
 *         instantiation of the transport, either in this or another process.
*/
int MbimTransport_Initialize(MbimTransport* pThis, char *devicePath, uint32_t maxExpectedInformationLength, bool skipOpen);
 ...
 * @param[in] pThis      The primary object of this call.
 * @param[in] skipClose  True to skip issuing a MBIM_CLOSE request as part of shutdown.
 *       
 * @note   skipClose is used when we wish to preserve the current MBIM connection status so that it may 
 *         be inherited by a future instantiation of the transport, either in this or another process.
*/
void MbimTransport_ShutDown(MbimTransport* pThis, bool skipClose);
 ...
 *
*/
void MbimTransport_CancelAllTransactionsUnsafe(MbimTransport* pThis);
